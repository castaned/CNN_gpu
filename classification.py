...
# how to get a file from google colab directly  
#    gdown --id 1T11faAqJzPFc67eSTibyrfyG1wVl5NXr


#convert jupyter notebook files to pure python 
...
# Estas lineas yo las inclui y son exclusivas si cuentas con una tarjeta GPU (Nvidia) configurada (CUDA+cudnn) 
